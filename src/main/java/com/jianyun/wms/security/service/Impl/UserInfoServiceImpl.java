package com.jianyun.wms.security.service.Impl;

import com.jianyun.wms.domain.UserInfoDO;
import com.jianyun.wms.domain.UserInfoDTO;
import com.jianyun.wms.exception.UserInfoServiceException;
import com.jianyun.wms.security.service.Interface.UserInfoService;
import com.jianyun.wms.security.util.EncryptingModel;
import com.jianyun.wms.dao.RolesMapper;
import com.jianyun.wms.dao.UserInfoMapper;
import com.jianyun.wms.dao.UserPermissionMapper;
import com.jianyun.wms.domain.RoleDO;
...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        EncryptingModel encryptingMode = new EncryptingModel();
        String tempStr = encryptingMode.MD5("1001");
        System.out.println(encryptingMode.MD5(tempStr + "1001"));
    }
